...
[_BASE] = LAYOUT_split_3x5_3_encoder(
	...
	LSFT_T(KC_Z), KC_X, KC_C, KC_V, KC_B, KC_MUTE, 		KC_N, KC_M, KC_COMM, KC_DOT, RSFT_T(KC_SLSH), 
	KC_ESC, MO(1), LT(4,KC_ENT), KC_LCTL, KC_LALT, LT(4,KC_LGUI), KC_SPC, LT(2,KC_DEL)
),
...
[_MOVE] = LAYOUT_split_3x5_3_encoder(
		KC_ESC, LGUI(KC_TAB), SGUI(KC_S), LALT(KC_F4), LSFT(KC_INS), 		KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_BSPC,
	       	...
	       	KC_PSCR, KC_NO, KC_NO, KC_NO, KC_NO, KC_MUTE,	 LSA(KC_N), KC_NO, KC_CAPS, KC_NUM, KC_INS,
	       	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TO(3), KC_TRNS, KC_TRNS, KC_NO 
),

[_NUMB] = LAYOUT_split_3x5_3_encoder(
		KC_1, KC_2, KC_3, KC_4, KC_5, 	KC_6, KC_7, KC_8, KC_9, KC_0,
	       	KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, 	KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,
	       	KC_TRNS, KC_TRNS, KC_TRNS, KC_F11, KC_F12, KC_MUTE, 		KC_INS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS,
...
[_NUMPAD] = LAYOUT_split_3x5_3_encoder(
		TO(0), KC_NO, KC_NO, KC_NO, KC_NO, 	KC_PMNS, KC_7, KC_8, KC_9, KC_PPLS,
	       	...
	       	KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_MUTE,		KC_PSLS, KC_1, KC_2, KC_3, KC_PEQL,
...
[_SYMB] = LAYOUT_split_3x5_3_encoder(
		KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, 	KC_CIRC, KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC,
	       	...
	       	KC_TILD, KC_GRV, KC_NO, KC_NO, KC_NO, KC_MUTE, 		KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLS,
